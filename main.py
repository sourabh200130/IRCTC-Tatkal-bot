...
driver.find_element(By.CSS_SELECTOR, 'input[placeholder="User Name"]').send_keys("SourabhShetty2001")
driver.implicitly_wait(1)
driver.find_element(By.CSS_SELECTOR, 'input[placeholder="Password"]').send_keys("Sourabh@123")
driver.implicitly_wait(1)
